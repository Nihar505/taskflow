...
> Task adding, completion, and deletion features with local JSON persistence are now available.
...
Alternatively, run `delete` without arguments to be prompted for the task ID interactively:
